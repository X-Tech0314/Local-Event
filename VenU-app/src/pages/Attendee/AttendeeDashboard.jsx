        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-3 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 p-3 rounded-lg">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-bold text-slate-900 dark:text-white leading-tight truncate flex items-center gap-1.5">
                <span className="truncate">{currentUser.firstName} {currentUser.lastName}</span>
                {currentUser.isVerified && (
                  <span title="Verified Profile" className="shrink-0 text-blue-500 bg-blue-50 dark:bg-blue-900/30 rounded-full p-0.5">
