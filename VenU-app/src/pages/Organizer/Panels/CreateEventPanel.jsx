...
export default function CreateEventPanel({ currentUser, setActivePanel, editEvent, setEditEvent }) {
 ...
 <div className="lg:col-span-7 bg-white dark:bg-slate-800 p-8 lg:p-12 relative overflow-y-auto">
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Event Title</label>
 <input
 ...
 className={`w-full bg-slate-50 dark:bg-slate-800 border rounded px-4 py-2.5 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-1 transition-all ${errors.Title ? 'border-red-400 focus:border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 />
 {errors.Title && <p className="text-red-500 text-xs mt-1 font-medium">{errors.Title}</p>}
 </div>

 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Category Tag</label>
 <select
 name="Category" value={formData.Category} onChange={handleInputChange}
 className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-4 py-2.5 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500 transition-all"
 >
 ...
 className={`w-full bg-slate-50 dark:bg-slate-800 border rounded px-4 py-2.5 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-1 transition-all ${errors.CustomCategory ? 'border-red-400 focus:border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 />
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Event Description</label>
 <textarea
 ...
 className={`w-full bg-slate-50 dark:bg-slate-800 border rounded px-4 py-2.5 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-1 transition-all resize-none ${errors.Description ? 'border-red-400 focus:border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 ></textarea>
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Event Banner / Cover Thumbnail</label>
 <div
 onDragOver={(e) => e.preventDefault()}
 onDrop={handleFileDrop}
 onClick={() => fileInputRef.current?.click()}
 className={`w-full h-[240px] rounded border-2 border-dashed flex flex-col items-center justify-center cursor-pointer transition-all overflow-hidden relative group
 ${bannerPreview ? 'border-slate-300 dark:border-slate-600' : 'border-slate-300 dark:border-slate-600 hover:border-purple-700 dark:border-purple-500 hover:bg-slate-100 dark:hover:bg-purple-900/10 bg-slate-50 dark:bg-slate-800'}`}
 >
 {bannerPreview ? (
 <>
 ...
 <div className="flex flex-col items-center text-slate-400 dark:text-slate-500 group-hover:text-slate-800 dark:text-slate-200 dark:group-hover:text-slate-500 transition-colors">
 ...
 className="w-full bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-700 dark:bg-purple-500 hover:text-white text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-800/50 py-3 rounded font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.99] "
 >
 ...
 <input type="date" name="StartDate" value={formData.StartDate} onChange={handleInputChange} onBlur={handleBlur} className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.StartDate ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 ...
 <Calendar size={16} className="text-slate-800 dark:text-slate-200 " />
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-50 dark:bg-slate-800 p-5 rounded border border-slate-200 dark:border-slate-700">
 <div className="space-y-2">
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Ticket Sales Open Date</label>
 <input type="date" name="TicketSalesStartDate" value={formData.TicketSalesStartDate} onChange={handleInputChange} onBlur={handleBlur} className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.TicketSalesStartDate ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 </div>
 <div className="space-y-2">
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Ticket Sales Open Time</label>
 <input type="time" name="TicketSalesStartTime" value={formData.TicketSalesStartTime} onChange={handleInputChange} onBlur={handleBlur} className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.TicketSalesStartTime ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 </div>
 <div className="space-y-2">
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mt-2">Ticket Sales Close Date</label>
 <input type="date" name="TicketSalesEndDate" value={formData.TicketSalesEndDate} onChange={handleInputChange} onBlur={handleBlur} className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.TicketSalesEndDate ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 </div>
 <div className="space-y-2">
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mt-2">Ticket Sales Close Time</label>
 <input type="time" name="TicketSalesEndTime" value={formData.TicketSalesEndTime} onChange={handleInputChange} onBlur={handleBlur} className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.TicketSalesEndTime ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 </div>
 </div>
 ...
 className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 py-3 px-6 rounded font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.99]"
 >
 ...
 className="flex-grow bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-700 dark:bg-purple-500 hover:text-white text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-800/50 py-3 rounded font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.99] "
 >
 ...
 <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2"><MapPin size={16} className="text-slate-800 dark:text-slate-200 " /> Location Details</h3>
 <div className="flex bg-slate-100 dark:bg-slate-800 rounded p-1 mt-2 sm:mt-0 border border-slate-200 dark:border-slate-700 w-full sm:w-auto">
 <button
 onClick={() => setVenueSourcingMode('registered')}
 className={`flex-1 sm:flex-none px-4 py-2 rounded-lg text-xs font-bold transition-all ${venueSourcingMode === 'registered' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-200 ' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
 >
 Search Registered Venues
 </button>
 <button
 onClick={() => setVenueSourcingMode('custom')}
 className={`flex-1 sm:flex-none px-4 py-2 rounded-lg text-xs font-bold transition-all ${venueSourcingMode === 'custom' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-200 ' : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'}`}
 >
 Enter Custom Venue
 </button>
 </div>
 ...
 <div className="bg-slate-50 dark:bg-slate-800 p-5 rounded border border-slate-200 dark:border-slate-700 space-y-4">
 ...
 className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded pl-10 pr-3 py-3 text-sm text-slate-900 dark:text-white outline-none focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500 transition-all"
 />
 </div>
 ...
 className={`p-4 rounded border cursor-pointer transition-all ${selectedVenueId === venue.id ? 'bg-slate-100 dark:bg-slate-700 border-purple-700 dark:border-purple-500 ' : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-purple-300 dark:hover:border-purple-700'}`}
 >
 <div className="flex justify-between items-start">
 <div>
 <h4 className={`font-bold ${selectedVenueId === venue.id ? 'text-slate-800 dark:text-slate-200 dark:text-purple-300' : 'text-slate-900 dark:text-white'}`}>{venue.name}</h4>
 <p className="text-xs text-slate-500 mt-1">{venue.address}</p>
 </div>
 <span className="flex items-center gap-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 px-2 py-1 rounded text-[10px] font-semibold tracking-wider">
 <CheckCircle size={10} /> Verified
 </span>
 </div>
 <div className="flex items-center gap-4 mt-3 text-xs font-bold text-slate-500">
 <span className="flex items-center gap-1 text-slate-700 dark:text-slate-300"><Star size={12} fill="currentColor" /> {venue.rating}</span>
 ...
 {selectedVenueId && (
 <div className="p-3 bg-slate-100 dark:bg-slate-700 border border-purple-200 dark:border-purple-800 rounded text-xs text-slate-800 dark:text-slate-200 dark:text-purple-300">
 ...
 <div className="space-y-4 animate-fade-in">
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Venue Name</label>
 <input type="text" name="VenueName" value={formData.VenueName} onChange={handleInputChange} placeholder="e.g., Wency's Studio, Community Hall" className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all" />
 </div>
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Venue Type</label>
 <select
 name="VenueType" value={formData.VenueType} onChange={handleInputChange} onBlur={handleBlur}
 className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2.5 text-sm text-slate-900 dark:text-white outline-none transition-all ${errors.VenueType ? 'border-red-400 focus:ring-1 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 >
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Floor Level</label>
 <input type="text" name="FloorLevel" value={formData.FloorLevel} onChange={handleInputChange} placeholder="e.g., Level 3, Lower Ground Floor" className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all" />
 </div>
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Wing / Section / Zone</label>
 <input type="text" name="WingSection" value={formData.WingSection} onChange={handleInputChange} placeholder="e.g., Cyberzone, Bldg B, Atrium" className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all" />
 </div>
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Booth / Stall / Table #</label>
 <input type="text" name="BoothNumber" value={formData.BoothNumber} onChange={handleInputChange} placeholder="e.g., Booth A12, Stall 4" className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all" />
 </div>
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Proximity Anchor / Landmark</label>
 <input type="text" name="ProximityAnchor" value={formData.ProximityAnchor} onChange={handleInputChange} placeholder="e.g., Beside Starbucks, Near the central escalator" className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all" />
 </div>
 </div>
 ) : (
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Street Address</label>
 <input type="text" name="StreetAddress" value={formData.StreetAddress} onChange={handleInputChange} onBlur={handleBlur} placeholder="123 Main Avenue, Building Floor..." className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:ring-1 transition-all ${errors.StreetAddress ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 {errors.StreetAddress && <p className="text-red-500 text-[10px] mt-1">{errors.StreetAddress}</p>}
 </div>
 )}

 <div className="mt-4 p-4 bg-slate-100 dark:bg-slate-700 border border-purple-200 dark:border-purple-800 rounded flex items-start gap-3">
 <input
 type="checkbox"
 ...
 className="mt-1 w-4 h-4 text-slate-800 dark:text-slate-200 bg-white border-slate-300 rounded focus:ring-purple-700 dark:focus:ring-purple-500"
 />
 <div>
 ...
 <p className="text-xs text-slate-800 dark:text-slate-200 mt-1">By checking this, you agree to make this venue publicly searchable by other organizers for their future events.</p>
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Region</label>
 <select
 name="Region" value={formData.Region}
 onChange={(e) => handleLocationChange('Region', e.target.value)} onBlur={handleBlur}
 className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2.5 text-sm text-slate-800 dark:text-white outline-none transition-all ${errors.Region ? 'border-red-400 focus:ring-1 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 >
 ...
 <div>
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Province</label>
 <select
 ...
 className={`w-full ${!formData.Region ? 'bg-slate-100 dark:bg-slate-800 cursor-not-allowed text-slate-400 dark:text-slate-500' : 'bg-white dark:bg-slate-800'} border rounded px-3 py-2.5 text-sm text-slate-800 dark:text-white outline-none transition-all ${errors.Province ? 'border-red-400 focus:ring-1 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 >
 ...
 <div>
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">City / Muni</label>
 <select
 ...
 className={`w-full ${!formData.Province ? 'bg-slate-100 dark:bg-slate-800 cursor-not-allowed text-slate-400 dark:text-slate-500' : 'bg-white dark:bg-slate-800'} border rounded px-3 py-2.5 text-sm text-slate-800 dark:text-white outline-none transition-all ${errors.City ? 'border-red-400 focus:ring-1 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 >
 ...
 <div>
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Barangay</label>
 <select
 ...
 className={`w-full ${!formData.City ? 'bg-slate-100 dark:bg-slate-800 cursor-not-allowed text-slate-400 dark:text-slate-500' : 'bg-white dark:bg-slate-800'} border rounded px-3 py-2.5 text-sm text-slate-800 dark:text-white outline-none transition-all ${errors.Barangay ? 'border-red-400 focus:ring-1 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500 focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500'}`}
 >
 ...
 <div className="w-1/3">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Postal / ZIP Code</label>
 <input type="text" name="ZipCode" value={formData.ZipCode} onChange={handleInputChange} onBlur={handleBlur} maxLength={4} placeholder="1103" className={`w-full bg-white dark:bg-slate-800 border rounded px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-1 ${errors.ZipCode ? 'border-red-400 focus:ring-red-500' : 'border-slate-200 dark:border-slate-700 focus:border-purple-700 dark:border-purple-500'}`} />
 {errors.ZipCode && <p className="text-red-500 text-[10px] mt-1">{errors.ZipCode}</p>}
 </div>
 <div className="flex-1">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Map / Location URL (Google Maps or Waze Link)</label>
 <input type="text" name="MapUrl" value={formData.MapUrl} onChange={handleInputChange} placeholder="https://maps.google.com/?q=..." className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500" />
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="flex bg-slate-200/50 dark:bg-slate-700/50 p-1 rounded mb-4 max-w-sm">
 <button
 onClick={() => setFormData(prev => ({ ...prev, AccessType: 'Public' }))}
 className={`flex-1 py-2 text-sm font-bold rounded-lg flex items-center justify-center gap-2 transition-all ${formData.AccessType === 'Public' ? 'bg-slate-800 dark:bg-slate-200 text-white ' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}
 >
 ...
 >
 <Lock size={14} className={formData.AccessType === 'Private' ? 'text-slate-800 dark:text-slate-200 ' : ''} /> Private/Invite
 </button>
 </div>

 {formData.AccessType === 'Private' && (
 <div className="animate-fade-in">
 <label className="block text-[10px] font-bold text-slate-800 dark:text-slate-200 tracking-wider mb-1">Mandatory Alphanumeric Invitation Access Code</label>
 <input
 type="text" name="VerificationCode" value={formData.VerificationCode} onChange={handleInputChange} placeholder="e.g. SECRET2026"
 className="w-full max-w-sm bg-white dark:bg-slate-800 border border-purple-700/50 dark:border-purple-500/50 dark:border-purple-500/30 rounded-lg px-3 py-2.5 text-slate-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-purple-700 dark:focus:ring-purple-500 transition-all font-mono text-sm"
 />
 </div>
 )}

 <div className="bg-slate-50 dark:bg-slate-800 p-5 rounded border border-slate-200 dark:border-slate-700">
 <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1 flex items-center gap-2"><Users size={16} className="text-slate-800 dark:text-slate-200 " /> Digital E-Ticket Types</h3>
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Admission Strategy</label>
 <select
 value={admissionStrategy} onChange={(e) => setAdmissionStrategy(e.target.value)}
 className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500 transition-all"
 >
 ...
 <div>
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-2">Total Capacity Limit</label>
 <input
 ...
 <div className="space-y-3">
 <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Ticket Tiers & Pricing</label>

 {formData.TicketTiers.map((tier, index) => (
 <div key={index} className="flex flex-col gap-3 bg-white dark:bg-slate-800 p-4 rounded border border-slate-200 dark:border-slate-700 relative group ">
 <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-start">
 <div className="md:col-span-4">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Tier Name</label>
 ...
 <div className="w-1/2">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1 truncate" title="Online E-Ticket Slots">App Slots</label>
 ...
 <div className="w-1/2">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1 truncate" title="On-Site F2F Slots">F2F Slots</label>
 ...
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Price (₱)</label>
 <input type="number" value={tier.Price} onChange={(e) => updateTicketTier(index, 'Price', e.target.value)} disabled={admissionStrategy === 'Free Admission'} placeholder={admissionStrategy === 'Free Admission' ? '0' : 'Price'} className={`w-full bg-slate-50 border rounded-lg px-2 py-2 text-sm focus:outline-none focus:border-purple-700 dark:border-purple-500 ${admissionStrategy === 'Free Admission' ? 'dark:bg-slate-800 cursor-not-allowed border-slate-200 dark:border-slate-700 text-slate-400' : 'dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white'}`} />
 </div>
 ...
 <div className="mt-1">
 <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wider mb-1">Validity Scope</label>
 <select value={tier.ValidityScope} onChange={(e) => updateTicketTier(index, 'ValidityScope', e.target.value)} className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-purple-700 dark:border-purple-500">
 ...
 className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 py-3 px-6 rounded font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.99] disabled:opacity-50"
 >
 <ChevronLeft size={18} /> Back
 </button>
 <button
 ...
 <h3 className="text-slate-500 dark:text-slate-400 font-semibold text-center mb-6 text-sm flex items-center justify-center gap-2">
 <Ticket size={16} className="text-slate-800 dark:text-slate-200 " /> Live Ticket Preview
 </h3>
 {/* Holographic Ticket Stub replacing old inline element */}
 <div className="relative transform transition-transform hover:scale-105 duration-300 rounded">
 <TicketPreview
 themeColor="#9333ea"
 eventData={{
 title: formData.Title,
 ...
 <div className="h-4 w-3/4 bg-purple-50 dark:bg-slate-700/50 rounded-md"></div>
 <div className="h-20 w-full bg-purple-50 dark:bg-slate-700/50 rounded mt-4"></div>
 </div>
 </div>
 <div className="w-full h-12 bg-purple-700 dark:bg-purple-500 rounded flex items-center justify-center cursor-not-allowed opacity-50 shadow-md">
